...
Other guidelines on interest for this master thesis included in this document are on the use of a standardised electrode placement and montage.
...
The most commonly used scheme for electrode placement is the international 10-20 system, which was first introduced in late 1950s \citep{internat_1020_system}.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \captionsetup{justification=centering}
        \caption{Electrode placement and channel names of the international 10-20 system. Figure by TOMATON, Public domain, via Wikimedia Commons.\\ \hfill}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \captionsetup{width=0.95\linewidth}
        \captionsetup{justification=centering}
        \caption{Electrode placement and channel names of the modified combinatorial nomenclature for the 10-10 system. Figure by Brylie Christopher Oxley, CC0, via Wikimedia Commons.}
