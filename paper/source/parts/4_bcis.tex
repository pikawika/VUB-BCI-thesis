...
Section \ref{subsec:biomedical_signals_working_with_eeg_brain_waves} talks about these brain wave frequencies in more detail.
...
As section \ref{subsec:biomedical_signals_measuring_brain_artefacts} will discuss in greater detail, such an approach has many negatives.
...
This external noise includes common artifacts such as electrical interference and the detection of \gls{emg}, which will be discussed in more detail in Section \ref{subsec:biomedical_signals_measuring_brain_artefacts}.
