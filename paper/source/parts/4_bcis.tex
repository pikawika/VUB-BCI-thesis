% TODO:
%   - Zou klaar moeten zijn maar laatste section nog nalezen want afhankelijk rest thesis
% ----------  
% Questions:
%   - 
...
Section \ref{subsec:biomedical_signals_from_brain_brain_waves} talks about these brain wave frequencies in more detail.
...
As further discussed in \ref{subsec:biomedical_signals_measuring_modalities}, this invasive method places flexible electrodes directly inside the skull.
...
Section \ref{subsec:biomedical_signals_from_brain_inducing_methods} will go into further detail on the types of measurable brain-signals.
...
This process of thinking of movement but not doing the movement is known as \glsfirst{mi} and further discussed in Section \ref{subsec:biomedical_signals_from_brain_inducing_methods}.
...
As further discussed in section \ref{subsec:biomedical_signals_from_brain_inducing_methods}, a P300 signal is a positive bio-electrical wave measurable with \gls{eeg} around 300ms after a specific stimulus occurred.
