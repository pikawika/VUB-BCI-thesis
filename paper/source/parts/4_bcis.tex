% TODO:
%   - Changes Arnau
%   - P300 is GEEN steady state (zie Common methods for inducing electrical brain activity)
%   - Further subdivision of "four papers to bci" mogelijk want we hebben bv offline classi dat nog verder studied zou moeten worden voor online use
% ----------  
% Questions:
%   - 
...
Section \ref{subsec:processing_signals_evaluating_and_using_evaluation} discusses how to evaluate systems using different metrics and reasoning in more detail.
...
% TODO: reread once thesis finished to provide better references
...
Such a general model can also be used as a base model for calibration, a process based on the idea of \glsfirst{tl} further discussed in Section \ref{subsec:processing_signals_evaluating_and_using_calibration}.
...
% TODO: redo this part once thesis is finished
...
The next part, Part \ref{part:development} puts this theory to practice by discussing the development of multiple \gls{bci} pipelines.
This includes the implementation of state-of-the-art two-step \gls{ml} approaches and one-step \gls{dl} approaches.
Two \gls{lstm} extensions to the \gls{cnn} based EEGNet model are also proposed.
