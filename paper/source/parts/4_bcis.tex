...
This first chapter gave an in-depth introduction to \glspl{bci}.
...
All of the implemented variants of the \gls{bci} pipeline are compared and further discussed in the final part of this master thesis, Part \ref{part:reflection}.